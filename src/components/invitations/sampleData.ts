...
// Provenza reutiliza el tipo DolceVitaContent (misma estructura)
export const provenzaSample: DolceVitaContent = {
  ...dolceVitaSample,
  groom: 'Miguel',
  bride: 'Annie',
  dateCity: 'Cieneguilla',
  dateWeekday: 'Sábado',
  dateDay: '19',
  dateMonth: 'Septiembre',
  dateYear: '2026',
  isoDate: '2026-09-19T12:00:00',
  guestName: 'Daniel Martínez',
  guestPasses: '2 pases',
  coverImage: 'https://images.unsplash.com/photo-1519225421980-715cb0215aed?w=1200&q=80',
  introMessage: 'Nuestro gran día se aproxima y nos encantaría que formaras parte de él. Con el corazón lleno de ilusión, comenzamos el capítulo más hermoso de nuestra historia.',
  blessing: 'Con la bendición de Dios y de nuestras madres',
  parentsBride: ['Ana Montaño Pisfil'],
  parentsGroom: ['Violeta Urrelo García'],
  padrinos: ['Tania Montoya Zamora', 'Loreto Hermitaño Rosales'],
  ceremonyReligious: { time: '12:00 h', place: 'Jardines La Provenza', maps: 'https://maps.google.com' },
  ceremonyCivil: { time: '14:00 h', place: 'Jardines La Provenza', maps: 'https://maps.google.com' },
  reception: { time: '14:45 h', place: 'Jardines La Provenza', maps: 'https://maps.google.com' },
  dressCode: 'Formal. Agradecemos evitar los tonos blanco, ivory y perla, reservados para la novia. La celebración se realizará en un jardín: para mayor comodidad, sugerimos evitar tacones de punta.',
  itinerary: [
    { icon: 'rings', label: 'Ingreso de invitados', time: '12:00 h' },
    { icon: 'church', label: 'Ceremonia religiosa', time: '13:00 h' },
    { icon: 'couple', label: 'Ceremonia civil', time: '14:00 h' },
    { icon: 'cheers', label: 'Recepción', time: '14:45 h' },
    { icon: 'dance', label: 'Vals y brindis', time: '15:00 h' },
    { icon: 'party', label: 'Fiesta', time: '16:20 h' },
    { icon: 'dove', label: 'Despedida', time: '21:00 h' },
  ],
  giftMessage: 'Su presencia será nuestro regalo más valioso. Si desean obsequiarnos un detalle adicional, aquí les dejamos nuestra mesa de regalos.',
  giftCash: undefined,
  giftOther: undefined,
  galleryMsg: 'Queremos ver nuestra boda a través de tus ojos. Ayúdanos a guardar cada risa, cada abrazo y cada selfie.',
  noKids: 'Con el deseo de que todos disfruten plenamente de esta celebración, hemos decidido que nuestro matrimonio sea un evento exclusivo para adultos. Agradecemos su comprensión.',
  rsvpClosing: 'Es muy importante para nosotros conocer tu respuesta. Confirma tu asistencia antes del 10 de septiembre.',
  thanksMessage: 'El destino cruzó nuestros caminos, el amor unió nuestros corazones y hoy elegimos caminar juntos para toda la vida.',
};
